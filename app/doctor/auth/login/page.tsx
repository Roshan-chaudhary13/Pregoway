...
import { ArrowRight, Loader2, Stethoscope, Lock, Mail } from "lucide-react";
            ...
            <div className="hidden lg:flex flex-col justify-between w-1/2 relative overflow-hidden text-white p-12 bg-slate-900">
                ...
                <div className="z-10 relative">
                    <Link href="/" className="flex items-center gap-2 font-bold text-xl text-white hover:text-slate-200 transition-colors">
                        <Stethoscope className="text-emerald-400" /> Pregoway <span className="text-emerald-400 text-xs px-2 py-1 bg-emerald-400/10 rounded-full border border-emerald-400/20">DOCTOR</span>
                    </Link>
                </div>

                <div className="z-10 relative max-w-lg mb-8">
                    <h2 className="text-4xl font-bold mb-4 leading-tight">Empower Lives with Data.</h2>
                    <p className="text-lg text-slate-300 font-light">
                        Access real-time vitals, AI-driven risk alerts, and connect directly with expectant mothers who need your expertise.
                    </p>
                </div>

                <div className="text-xs text-slate-500 z-10 relative">
                    Authorized Personnel Only. © 2026 Pregoway Inc.
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-700">Medical Email</label>
